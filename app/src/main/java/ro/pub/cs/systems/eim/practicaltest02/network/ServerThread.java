...
public class ServerThread extends Thread {
    ...
    public synchronized void setData(String address, AlarmInformation alarmInformation) {
        this.data.put(address, alarmInformation);
    }

    public synchronized void removeAlarm(String key) {
        data.remove(key);
    }
